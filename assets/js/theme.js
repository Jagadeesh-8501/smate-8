...
$("body").addClass("tt-light-style-on"); // Default to light mode
$("#tt-themecss").after('<link id="tt-light-style" rel="stylesheet" href="assets/css/light-style.css">'); // Load light stylesheet

// Check localStorage for theme preference
var d = localStorage.getItem("lightstyle");
if (d === "false") {
    $("body").removeClass("tt-light-style-on").addClass("tt-dark-style-on"); // Switch to dark mode
    $("#tt-light-style").remove(); // Remove light stylesheet
    $("#tt-themecss").after('<link id="tt-dark-style" rel="stylesheet" href="assets/css/dark-style.css">'); // Load dark stylesheet
}

// Click on style switch
$(".tt-style-switch").on("click", function() {
    $("body").toggleClass("tt-light-style-on tt-dark-style-on");
    if ($("body").hasClass("tt-light-style-on")) {
        localStorage.setItem("lightstyle", "true");
        $("#tt-dark-style").remove(); // Remove dark stylesheet if present
        $("#tt-themecss").after('<link id="tt-light-style" rel="stylesheet" href="assets/css/light-style.css">'); // Ensure light stylesheet is loaded
    } else {
        localStorage.setItem("lightstyle", "false");
        $("#tt-light-style").remove(); // Remove light stylesheet if present
        $("#tt-themecss").after('<link id="tt-dark-style" rel="stylesheet" href="assets/css/dark-style.css">'); // Load dark stylesheet
    }
});
